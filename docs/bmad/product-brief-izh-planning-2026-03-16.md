...
> _"izh t'aide à savoir par où commencer quand tout semble urgent. Tu vides ta tête, l'app t'aide à trier, tu agis."_
...
**Frustration centrale :** Elle ne procrastine pas par paresse — elle est paralysée par le volume. Elle sait qu'elle devrait trier. Ce qui échoue, c'est que chaque outil lui demande un effort d'organisation _avant_ de l'aider.

**Succès :** _"Incroyable, je fais toutes mes tâches, je me sens mieux organisée et beaucoup plus légère mentalement. Je sais où je vais."_
...
**Succès :** Savoir quoi réviser _maintenant_ plutôt que paniquer devant la liste entière.
