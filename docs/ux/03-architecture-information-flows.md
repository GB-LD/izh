...
> *Les overlays sont des surfaces de niveau 2 qui se superposent à un écran sans changer de contexte. L'utilisateur sait toujours où il est (Nogier ❶).*
...
*Template BMAD-UX v1.0 — basé sur Nogier (Architecture de l'information, 3 questions de navigation, profondeur vs. largeur), Card Sorting, Dual-track Agile*
