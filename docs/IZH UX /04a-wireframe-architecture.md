...
> *Décisions UX qui impactent plusieurs écrans. Chacune est documentée en détail dans `knowledge/`.*
...
> *Liste des composants récurrents identifiés. À spécifier dans le livrable 06.*
...
*Template BMAD-UX v1.2 — basé sur les principes de hiérarchie visuelle (Nogier), séparation structure/style (Kholmatova), lois de Gestalt*
